...
<body>
    <div class="navbar">
        ...
        <a href="../html/ex12.html" id="active">Exercício 12</a>
    ...
    <h2>Resultado</h2>
        <?php
            ...
            $horario_em_segundos = ($horas * 60 * 60) + ($minutos * 60) + $segundos;
            echo "<p>O horário $horas:$minutos:$segundos corresponde a $horario_em_segundos segundos.</p>";
        ?>
        <a href="../html/ex12.html"><button>OK</button></a>
    </div>
</body>
</html>