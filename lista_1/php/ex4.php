...
<body>
    <div class="navbar">
        ...
        <a href="../html/ex4.html" id="active">Exercício 04</a>
    ...
    <?php
        ...
        if ($resto == 0) { echo "<p>O número $num é par</p>"; }
        else { echo "<p>O número $num é ímpar</p>"; }
    ?>
    <a href="../html/ex4.html"><button>OK</button></a>
    </div>
</body>
</html>