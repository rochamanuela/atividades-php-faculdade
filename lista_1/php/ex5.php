...
<body>
    <div class="navbar">
        ...
        <a href="../html/ex5.html" id="active">Exercício 05</a>
    ...
    <?php
        ...
        if ($num < 0) { echo "<p>O número $num é negativo</p>"; }
        else { echo "<p>O número $num é positivo</p>"; }
    ?>
    <a href="../html/ex5.html"><button>OK</button></a>
    </div>
</body>
</html>