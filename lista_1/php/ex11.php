...
<body>
    <div class="navbar">
        ...
        <a href="../html/ex11.html" id="active">Exercício 11</a>
    ...
    <h2>Resultado</h2>
        <?php
            $valor = $_POST['valor'];
            $ajuste = ($valor * 0.1) + $valor;
            echo "<p>O valor, com ajuste de 10%, é $ajuste.</p>";
        ?>
        <a href="../html/ex11.html"><button>OK</button></a>
    </div>
</body>
</html>